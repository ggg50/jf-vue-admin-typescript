...
这个项目最初是从一个非常好用的后台框架 [vue-typescript-admin-template](https://github.com/Armour/vue-typescript-admin-template) 拷贝过来的（2020-05-22）

然后，在它的基础上逐步做一些自己的封装

src/api/testData 是测试数据的目录，对于这个项目来说挺重要，接口返回数据的 type , 以及 mock 数据都依赖于它。
